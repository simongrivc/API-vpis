...
{ 
 	...
 	protected $attributes  = ['api_token', 'activation_code', 'username', 'email', 'is_active', 'name', 'surname', 'fk_activation_code', 'fk_user_role', 'last_login', 'fk_id_vis_institution', 'vis_institution_name'];
