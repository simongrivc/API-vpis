...
{ 
	//id fk_id_type fk_id_program_carrier	sequence_number	serial_id	program_name
 	protected $fillable = ['id', 'fk_id_type', 'fk_id_call_group', 'fk_id_program_carrier', 'sequence_number', 'serial_id', 'program_name', 'type_name', 'institution_name', 'abbreviation', 'fk_id_municipality', 'fk_id_university', 'municipality_name', 'university_name', 'fk_id_call_type', 'call_type_name', 'nr_slo_eu', 'nr_without_citizenship_foreigners','min_nr_points', 'is_active', 'nr_slo_eu_applications' => '0', 'nr_foreigners_applications' => '0', 'nr_slo_eu_accepted' => '0', 'nr_foreigners_accepted' => '0'];

 	protected $attributes  = ['id', 'fk_id_type', 'fk_id_call_group','fk_id_program_carrier', 'sequence_number', 'serial_id', 'program_name', 'type_name', 'institution_name', 'abbreviation', 'fk_id_municipality', 'fk_id_university', 'municipality_name', 'university_name', 'fk_id_call_type', 'call_type_name', 'nr_slo_eu', 'nr_without_citizenship_foreigners','min_nr_points', 'is_active','nr_slo_eu_applications' => '0', 'nr_foreigners_applications' => '0', 'nr_slo_eu_accepted' => '0', 'nr_foreigners_accepted' => '0'];
